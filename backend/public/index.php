...
$app->get('/contact/view/{id}', [$contactController, 'getFormById']);
$app->post('/contact', [$contactController, 'submitForm']);
$app->put('/contact/{id}', [$contactController, 'updateForm']);
$app->delete('/contact/{id}', [$contactController, 'deleteForm']);
