<template>
    <div class="home">
        ...
        <div v-if="loggedInUser">
            <router-link to="/"><button class="cn"><a href="#" @click="participate">WELCOME</a></button></router-link>
        </div>
        <div v-else>
            <router-link to="/login"><button class="cn"><a href="#" @click="participate">PARTICIPATE</a></button></router-link>
        </div>
    </div>
</template>
